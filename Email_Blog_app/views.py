...
from wyge.agents.prebuilt_agents import ResearchAgent, VideoAudioBlogAgent, YTBlogAgent, BlogAgent, VideoAgent, EmailAgent
    ...
    if request.method == 'POST':
        ...
        try:
            if option == 'website url to blog':
                ...
                contents = blog_agent.generate_blog(topic, url)
            ...
            #     context = research_agent.extract_text_from_audio_or_video(topic, url)
