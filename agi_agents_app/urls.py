...
from .views import registerPage,get_user_details,loginPage,googlelogin,agent_list, agent_detail, agent_create, modify_agent,add_email,reject_agent,view_agents_by_status
