...
from .views import registerPage,get_user_details,loginPage,googlelogin,agent_list, agent_detail, agent_create, modify_agent,add_email,delete,create_submission_view,get_submission_view,update_submission_view,delete_submission_view
