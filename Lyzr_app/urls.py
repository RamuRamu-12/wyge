...
urlpatterns = [
    ...
    path('environments_by_email', views.get_all_environments_by_email, name='read_all_environments_by_mail'),
    ...
    path('agents_by_mail', views.get_all_agents_by_email, name='read_all_agents_by_mail'),
    ...
    path('dyn_agents_by_mail', views.get_all_dynamic_agents_by_email, name='read_all_dyn_agents_by_mail'),
